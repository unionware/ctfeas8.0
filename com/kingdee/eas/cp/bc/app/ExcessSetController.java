...
public interface ExcessSetController extends DataBaseController
{
    public ExcessSetInfo getExcessSetInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException, RemoteException;
    public ExcessSetInfo getExcessSetInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public ExcessSetInfo getExcessSetInfo(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
