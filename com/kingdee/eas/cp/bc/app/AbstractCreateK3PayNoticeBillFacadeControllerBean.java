...
public abstract class AbstractCreateK3PayNoticeBillFacadeControllerBean extends AbstractBizControllerBean implements CreateK3PayNoticeBillFacadeController
{
    ...
    public void checkBillHasCreate(Context ctx, BOSUuid id) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("5f2865a0-7fad-4e60-87c7-f542d3d879da"), new Object[]{ctx, id});
            invokeServiceBefore(svcCtx);
              if(!svcCtx.invokeBreak()) {
            _checkBillHasCreate(ctx, id);
            }
            invokeServiceAfter(svcCtx);
        } catch (BOSException ex) {
            throw ex;
    ...
    protected void _checkBillHasCreate(Context ctx, BOSUuid id) throws BOSException, EASBizException
    {    	
        return;
    }

    public boolean checkBillHasCreate2(Context ctx, BOSUuid id) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("19b46972-88ab-4156-9fde-e12c6b9fa10d"), new Object[]{ctx, id});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
            boolean retValue = (boolean)_checkBillHasCreate2(ctx, id);
    ...
    protected boolean _checkBillHasCreate2(Context ctx, BOSUuid id) throws BOSException, EASBizException
    {    	
        return false;
    }
