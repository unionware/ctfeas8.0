...
public abstract class AbstractDailyLoanBillControllerBean extends LoanBillControllerBean implements DailyLoanBillController
{
    ...
    public DailyLoanBillInfo getDailyLoanBillInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException
    {
        try {
          ...
          return (DailyLoanBillInfo)svcCtx.getMethodReturnValue();
    ...
    public DailyLoanBillCollection getDailyLoanBillCollection(Context ctx) throws BOSException
    {
        try {
          ...
          return (DailyLoanBillCollection)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } finally {
            super.cleanUpServiceState();
    ...
    public BgCtrlParam[] getBgParam(Context ctx, BOSUuid id) throws BOSException, EASBizException
    {
        try {
            ...
            invokeServiceAfter(svcCtx);
            return (BgCtrlParam[])svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            this.setRollbackOnly();
            throw ex;
        } catch (EASBizException ex0) {
    ...
    public boolean abandonFromContract(Context ctx, BOSUuid billId) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("dfca1b7b-f633-4ba9-b589-bd600a834db0"), new Object[]{ctx, billId});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
            boolean retValue = (boolean)_abandonFromContract(ctx, billId);
            svcCtx.setMethodReturnValue(new Boolean(retValue));
            }
            invokeServiceAfter(svcCtx);
            return ((Boolean)svcCtx.getMethodReturnValue()).booleanValue();
    ...
    protected boolean _abandonFromContract(Context ctx, BOSUuid billId) throws BOSException
    {    	
        return false;
    }
