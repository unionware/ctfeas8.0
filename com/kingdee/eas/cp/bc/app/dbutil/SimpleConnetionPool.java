...
public class SimpleConnetionPool {
	...
	private static void initDriver() {
		...
		// load mssql driver
		try {
			driver = (Driver) Class.forName("com.microsoft.jdbc.sqlserver.SQLServerDriver")
					.newInstance();
		...
		// load oracle driver
		try {
			driver = (Driver) Class.forName("oracle.jdbc.driver.OracleDriver")
					.newInstance();
			installDriver(driver);
		} catch (Exception e) {
		}
	...
	private static ConnectionWrapper getNewConnection() throws SQLException {
		try {
