...
public abstract class AbstractEvectionLoanBillControllerBean extends LoanBillControllerBean implements EvectionLoanBillController
{
    ...
    public EvectionLoanBillInfo getEvectionLoanBillInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException
    {
        try {
          ...
          return (EvectionLoanBillInfo)svcCtx.getMethodReturnValue();
    ...
    public EvectionLoanBillCollection getEvectionLoanBillCollection(Context ctx) throws BOSException
    {
        try {
          ...
          return (EvectionLoanBillCollection)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } finally {
            super.cleanUpServiceState();
    ...
    public String payBack(Context ctx, String billID) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("60336717-8d7f-4c96-9745-0e08dee31127"), new Object[]{ctx, billID});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
            String retValue = (String)_payBack(ctx, billID);
            svcCtx.setMethodReturnValue(retValue);
            }
            invokeServiceAfter(svcCtx);
    ...
    protected String _payBack(Context ctx, String billID) throws BOSException
    {    	
        return null;
    }
