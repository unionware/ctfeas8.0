    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntries.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntries.putBindContents("editData",new String[] {"id","project","expenseType","costedDept","person","purpose","currencyType","exchangeRate","amountOri","amount","amountApprovedOri","amountApproved","amountUsedOri","amountUsed","amountBalanceOri","amountBalance","comment","convertMode","exchangeRatePrecision"});
