    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntries.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntries.putBindContents("editData",new String[] {"id","project","costDept","expenseType","person","purpose","participants","currencyType","exchangeRate","budgetAmountOri","budgetAmount","amountOri","amount","amountApprovedOri","amountApproved","amountUsedOri","amountUsed","amountBalanceOri","amountBalance","","comment","sourceBillNumber","sourceBillEntryID","convertMode","exchangeRatePrecision"});
