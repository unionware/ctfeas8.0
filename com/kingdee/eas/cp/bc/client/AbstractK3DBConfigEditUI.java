 ...
 * output class name
 */
public abstract class AbstractK3DBConfigEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractK3DBConfigEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contpwd;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtpwd;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtdbname;
    protected com.kingdee.eas.cp.bc.K3DBConfigInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractK3DBConfigEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractK3DBConfigEditUI.class.getName());
        ...
        this.contpwd = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtpwd = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        // contpwd		
        this.contpwd.setBoundLabelText(resHelper.getString("contpwd.boundLabelText"));		
        this.contpwd.setBoundLabelLength(100);		
        this.contpwd.setBoundLabelUnderline(true);		
        this.contpwd.setVisible(true);
        // contdbname		
        ...
        this.txtpwd.setHorizontalAlignment(2);		
        this.txtpwd.setMaxLength(100);		
        this.txtpwd.setRequired(true);
        // txtdbname		
        this.txtdbname.setVisible(true);		
        this.txtdbname.setHorizontalAlignment(2);		
        this.txtdbname.setMaxLength(100);		
        this.txtdbname.setRequired(true);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtip,txtport,txtusername,txtpwd,txtdbname}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 301, 209));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(13, 198, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(12, 14, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(14, 223, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(14, 244, 270, 19));
        this.add(kDLabelContainer4, null);
        contip.setBounds(new Rectangle(12, 46, 270, 19));
        this.add(contip, null);
        contport.setBounds(new Rectangle(12, 78, 270, 19));
        this.add(contport, null);
        contusername.setBounds(new Rectangle(12, 110, 270, 19));
        this.add(contusername, null);
        contpwd.setBounds(new Rectangle(12, 142, 270, 19));
        this.add(contpwd, null);
        contdbname.setBounds(new Rectangle(12, 174, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("pwd", String.class, this.txtpwd, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.cp.bc.app.K3DBConfigEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.cp.bc.K3DBConfigInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("pwd", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.cp.bc.client", "K3DBConfigEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtip.getText())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"IP"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtport.getText())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"PORT"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtusername.getText())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"登录用户名"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtpwd.getText())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"密码"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtdbname.getText())) {
