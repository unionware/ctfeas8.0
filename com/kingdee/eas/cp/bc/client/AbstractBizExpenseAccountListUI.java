...
public abstract class AbstractBizExpenseAccountListUI extends com.kingdee.eas.cp.bc.client.AccountBillListUI
{
    ...
    {
        return new String[] {"id","number","name","operationType","currencyType1","amount","amountApproved","amountEncashed","amountPaid","amountNotPaid","amountStriked","payMode","state","actionFlag","applier","orgUnit","bizReqDate","billTypeCode","amountSendedBack","budgetAmount","company","applierCompanyId","sourceId","cause","auditor","auditData","amountEncashed","discriptioin","contractNO","accessoryCount","voucherNum.voucherNumber","k3VoucherNumber","isK3Paid","specialInvoice","payCompany.name","orgUnit.id"};
    }
