 ...
 * output class name
 */
public abstract class AbstractK3DBConfigListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractK3DBConfigListUI.class);
    /**
     * output class constructor
     */
    public AbstractK3DBConfigListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.cp.bc.app.K3DBConfigListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("pwd"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.cp.bc.client", "K3DBConfigListUI");
    }
    ...
    {
        return com.kingdee.eas.cp.bc.client.K3DBConfigEditUI.class.getName();
    }
