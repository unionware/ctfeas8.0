 ...
 * output class name
 */
public abstract class AbstractBaseDataMatchListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseDataMatchListUI.class);
     ...
     */
    public AbstractBaseDataMatchListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBaseDataMatchListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.cp.bc.app", "BaseDataMatchQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.cp.bc.app.BaseDataMatchListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.easNum"));
        sic.add(new SelectorItemInfo("entrys.k3Num"));
        sic.add(new SelectorItemInfo("types"));
        return sic;
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBaseDataMatchListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseDataMatchListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.cp.bc.client", "BaseDataMatchListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.cp.bc.client.BaseDataMatchEditUI.class.getName();
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","types"};
    }



	protected String getTDFileName() {
    	return "/bim/cp/bc/BaseDataMatch";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.cp.bc.app.BaseDataMatchQuery");
	}
