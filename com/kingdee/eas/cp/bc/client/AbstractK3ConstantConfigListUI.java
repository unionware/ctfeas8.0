 ...
 * output class name
 */
public abstract class AbstractK3ConstantConfigListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractK3ConstantConfigListUI.class);
    /**
     * output class constructor
     */
    public AbstractK3ConstantConfigListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.cp.bc.app.K3ConstantConfigListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.cp.bc.client", "K3ConstantConfigListUI");
    }
