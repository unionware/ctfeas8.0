...
public abstract class AbstractTravelExpenseAccountListUI extends com.kingdee.eas.cp.bc.client.AccountBillListUI
{
    ...
    {
        return new String[] {"id","number","name","operationType","travelType.name","currencyType1","amount","amountApproved","amountEncashed","actionFlag","amountPaid","amountNotPaid","amountStriked","payMode","state","applier","orgUnit","bizReqDate","billTypeCode","amountSendedBack","budgetAmount","applierCompanyId","sourceId","cause","auditor","auditData","amountEncashed","specialInvoice","payCompany","discription","orgUnit.id"};
    }
