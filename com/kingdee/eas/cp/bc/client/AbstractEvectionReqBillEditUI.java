    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntries.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntries.putBindContents("editData",new String[] {"id","project","expenseType","costedDept","person","startDate","endDate","from","to","partner","vehicle","currencyType","exchangeRate","amountOri","amount","convertMode","exchangeRatePrecision"});
