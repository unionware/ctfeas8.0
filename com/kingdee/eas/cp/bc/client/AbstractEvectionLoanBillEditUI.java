    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntries.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntries.putBindContents("editData",new String[] {"id","expenseType","project","costedDept","person","startDate","endDate","from","to","vehicle","currencyType","exchangeRate","bussesExpense","taxiExpense","hotelExpense","otherExpense","budgetAmountOri","budgetAmount","amountOri","amount","amountApprovedOri","amountApproved","amountUsedOri","amountUsed","amountBalanceOri","amountBalance","convertMode","exchangeRatePrecision"});
