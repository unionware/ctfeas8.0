...
public abstract class AbstractLoanReqListUI extends com.kingdee.eas.cp.bc.client.BizCollCoreBillListUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tbnReturn;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tbnReturn = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        ...
        this.tbnReturn.setName("tbnReturn");
        ...
        // tbnReturn
        this.tbnReturn.setAction((IItemAction)ActionProxyFactory.getProxy(actionReturn, new Class[] { IItemAction.class }, getServiceContext()));		
        this.tbnReturn.setText(resHelper.getString("tbnReturn.text"));		
        this.tbnReturn.setToolTipText(resHelper.getString("tbnReturn.toolTipText"));
        // btnComfirmReturn
        ...
        this.btnComfirmReturn.setToolTipText(resHelper.getString("btnComfirmReturn.toolTipText"));
        // menuItemBatchSubmit
    ...
    {
        return new String[] {"id","number","name","cause","operationType","currencyType1","amount","approvedAccount","amountPaid","amountNotPaid","amountUsed","amountSendedBack","amountBalance","payMode","amountControlType","currencyType.id","applier.id","state","isOverBudget","isVouchered","applier.name","company.id","company.name","applierCompanyId","orgUnit.id","orgUnit.name","bizReqDate","billTypeCode","prior","billDate","CU.id","auditData","auditor","description","voucherNumber","returnState","returnAmt","isK3Paid","voucherNum.voucherNumber","contractNO","receiveObject"};
    }
