...
public class DailyLoanBill extends LoanBill implements IDailyLoanBill
{
    ...
    /**
     *有合同废弃-User defined method
     *@param billId 单据ID
     *@return
     */
    public boolean abandonFromContract(BOSUuid billId) throws BOSException
    {
        try {
            return getController().abandonFromContract(getContext(), billId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
