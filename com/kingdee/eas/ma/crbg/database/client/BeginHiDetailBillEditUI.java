 ...
 * output class name
 */
public class BeginHiDetailBillEditUI extends AbstractBeginHiDetailBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BeginHiDetailBillEditUI.class);
    
    /**
     * output class constructor
     */
    public BeginHiDetailBillEditUI() throws Exception
    {
        super();
    }
    /**
