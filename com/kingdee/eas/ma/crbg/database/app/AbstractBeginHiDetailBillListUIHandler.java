 ...
 * output class name
 */
public abstract class AbstractBeginHiDetailBillListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleactionImportProsess(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleactionImportProsess(request,response,context);
	}
	protected void _handleactionImportProsess(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}