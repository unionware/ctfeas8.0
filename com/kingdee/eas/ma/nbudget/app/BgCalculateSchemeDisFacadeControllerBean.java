...
public class BgCalculateSchemeDisFacadeControllerBean extends AbstractBgCalculateSchemeDisFacadeControllerBean
{
	/**
	...
	private static final long serialVersionUID = 6584113341578336872L;
	private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ma.nbudget.app.BgCalculateSchemeDisFacadeControllerBean");
...
//    							
    ...
    private void checkBgFormState(List bgFormList,List reportList,FullOrgUnitInfo orgUnitInfo,BgTemplateInfo bgTemplateInfo,
    	...
    	for (int i = bgFormList.size()-1;i>=0;i--){
    		...
    		if ( info.getState().getValue() == BgFormStateEnum.CERTIFICATE_VALUE){
    ...
    private List queryBgForm(Context ctx,String orgId,String bgSchemeId,String bgTemplateId,String bgPeriodId,String currencyId){
    	...
    	queryBgFormSql.append(" and fbgtemplateid = ? and fbgperiodid = ? and fcurrencyid = ? and fstate = "+BgFormStateEnum.CERTIFICATE_VALUE);
