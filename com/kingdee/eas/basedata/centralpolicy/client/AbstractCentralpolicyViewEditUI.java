 ...
 * output class name
 */
public abstract class AbstractCentralpolicyViewEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCentralpolicyViewEditUI.class);
     ...
     */
    public AbstractCentralpolicyViewEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCentralpolicyViewEditUI.class.getName());
        ...
        // kDScrollPane1
        // kdtxtContent		
        this.kdtxtContent.setFocusable(false);		
        this.kdtxtContent.setRequestFocusEnabled(false);
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDScrollPane1.setBounds(new Rectangle(2, 2, 847, 496));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.basedata.centralpolicy.app.CentralpolicyViewEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.basedata.centralpolicy.client", "CentralpolicyViewEditUI");
    }
